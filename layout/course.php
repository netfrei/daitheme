...
$PAGE->requires->js('/theme/dai/javascript/scrollspy.js');
$PAGE->requires->js('/theme/dai/javascript/tooltipfix.js');
$PAGE->requires->js('/theme/dai/javascript/blockslider.js');

$PAGE->requires->js('/theme/dai/javascript/courseblock.js');
