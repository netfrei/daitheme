...
$string['supportcontact'] = 'في حال حدوث أي طارئ أو اشكال الرجاء مراسلة الدعم التقني';
$string['login-link'] = 'دخول';
$string['register-link'] = 'إنشاء حساب جديد';
...
$string['choosereadme'] = 'Dai is inherited from Boost.';
$string['currentinparentheses'] = '(current)';
$string['configtitle'] = 'Dai';
$string['fontsize'] = 'Theme base fontsize';
$string['fontsize_desc'] = 'Enter a fontsize in %';
$string['generalsettings'] = 'General settings';
$string['nobootswatch'] = 'None';
$string['pluginname'] = 'NFDai';
$string['presetfiles'] = 'Additional theme preset files';
$string['presetfiles_desc'] = 'Preset files can be used to dramatically alter the appearance of the theme. See <a href=https://docs.moodle.org/dev/Boost_Presets>Boost presets</a> for information on creating and sharing your own preset files, and see the <a href=http://moodle.net/boost>Presets repository</a> for presets that others have shared.';
$string['preset'] = 'Theme preset';
$string['preset_desc'] = 'Pick a preset to broadly change the look of the theme.';
$string['privacy:metadata'] = 'The Dai theme does not store any personal data about any user.';
$string['rawscss'] = 'Raw SCSS';
$string['rawscss_desc'] = 'Use this field to provide SCSS or CSS code which will be injected at the end of the style sheet.';
$string['rawscsspre'] = 'Raw initial SCSS';
$string['rawscsspre_desc'] = 'In this field you can provide initialising SCSS code, it will be injected before everything else. Most of the time you will use this setting to define variables.';
$string['region-side-pre'] = 'Right';
$string['region-center-post'] = 'Content';
$string['region-left-region'] = 'Left';
$string['privacy:metadata:preference:draweropennav'] = 'The user\'s preference for hiding or showing the drawer menu navigation.';
$string['privacy:drawernavclosed'] = 'The current preference for the navigation drawer is closed.';
$string['privacy:drawernavopen'] = 'The current preference for the navigation drawer is open.';

$string['supportcontact'] = 'If there are any issues please contact the support';
$string['login-link'] = 'Login';
$string['register-link'] = 'Register';
$string['enrollcoursecard'] = 'Access';
// Presets Settings.
$string['presets_settings'] = 'Presets';
$string['favicon'] = 'Favicon';
$string['favicon_desc'] = 'Change the favicon for Dai. Images with a transparent background and 32px height will work best.  Allowed types: PNG, JPG, ICO';
...
$string['slide4info'] = 'Slide 4';
$string['slide4infodesc'] = 'Slide 4 details.';
...
$string['blockwidthdai'] = 'Block Column Width';
$string['blockwidthdai_desc'] = 'Adjust the width of the block column.';
...
// frontend
$string['headingcourses']='المقررات';
$string['allcourses']= 'كل المقررات الدراسية';
$string['howitworks']='كيفية استخدام الموقع';
